...
import com.github.davidmoten.graph.StateDiagramObsolete;
...
public class ShowLayouts extends JApplet {
    ...
    protected static String[] graph_names = { "Two component graph", "Random mixed-mode graph",
            "Miscellaneous multicomponent graph", "Random directed acyclic graph",
            "One component graph", "Chain+isolate graph", "Trivial (disconnected) graph",
            "State Diagram Graph" };
    ...
    private static final class LayoutChooser implements ActionListener {
        ...
        public void actionPerformed(ActionEvent arg0) {
            Object[] constructorArgs = { g_array[graph_index] };
            ...
            try {
                ...
                LayoutTransition<Integer, Number> lt = new LayoutTransition<Integer, Number>(vv,
                        vv.getGraphLayout(), l);
    ...
    private static JPanel getGraphPanel() {
        ...
        g_array[1] = MixedRandomGraphGenerator.generateMixedRandomGraph(graphFactory, vertexFactory,
                edgeFactory, new HashMap<Number, Number>(), 20, true, new HashSet<Integer>());
        ...
        g_array[7] = StateDiagramObsolete.createTestGraph();

        @SuppressWarnings("unchecked")
        Graph<Integer, Number> g = (Graph<Integer, Number>) g_array[4]; // initial
        // graph

        final VisualizationViewer<Integer, Number> vv = new VisualizationViewer<Integer, Number>(
                new FRLayout<Integer, Number>(g));

        vv.getRenderContext().setVertexFillPaintTransformer(
                new PickableVertexPaintTransformer<Integer>(vv.getPickedVertexState(), Color.red,
                        Color.yellow));
